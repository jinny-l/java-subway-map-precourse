...
public class InputView {
    ...
    private static final String INPUT_STATION_TO_REGISTER = INPUT_VIEW_PREFIX + "등록할 역 이름을 입력하세요.";
    private static final String INPUT_STATION_TO_DELETE = INPUT_VIEW_PREFIX + "삭제할 역 이름을 입력하세요.";
...
//    private static final String = "삭제할 구간의 역을 입력하세요.";
    ...
    public String readStationToRegister() {
        System.out.println(INPUT_STATION_TO_REGISTER);
        return readLine();
    }
